...
class AHP
{
	...
	public $alternative_id = array();
	public $alt_norm = array();
	public $result = array();
	public $result_norm = array();
	public $aggregated_result = array();
	public $ranking_result = array();
	...
	public function PrintPairWise(array $pw){
		$countCriteria = count($this->criteria);
		for ($c=0;$c<$countCriteria;$c++){
			echo "Criteria-$c : ". $this->criteria[$c]."<br>";
			echo "<table border=1>";
			$N = count($pw[$c]);
			for ($i=0;$i<$N;$i++){
				echo "<tr>";
